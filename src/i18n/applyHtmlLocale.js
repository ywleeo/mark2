...
export function applyHtmlLocale() {
    ...
    const attrs = [
        ...
        ['.ai-sidebar-title', 'textContent', 'ai.title'],
        ['.ai-sidebar-clear-btn', 'title', 'ai.clearChat'],
        ['.ai-sidebar-close-btn', 'title', 'ai.close'],
        ['.ai-context-file-name.is-empty', 'textContent', 'ai.noFile'],
        ['.ai-conversation-empty-text', 'textContent', 'ai.agentTitle'],
        ['.ai-conversation-empty-hint', 'textContent', 'ai.agentHint'],
        ['.ai-sidebar-input-field', 'placeholder', 'ai.placeholder'],
        ['.ai-sidebar-cancel-btn', 'textContent', 'ai.cancel'],
        ['.ai-sidebar-send-btn', 'textContent', 'ai.send'],
