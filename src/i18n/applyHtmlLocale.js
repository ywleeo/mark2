...
export function applyHtmlLocale() {
  ...
  const attrs = [
    ...
    [
      '.ai-auto-edit-chip [data-i18n="ai.autoEdit.label"]',
      "textContent",
      "ai.autoEdit.label",
    ],
    ...
    [
      ".search-button.toggle-replace-btn .search-button-label",
      "textContent",
      "search.replaceLabel",
    ],
    ...
    [
      ".search-button.replace-btn .search-button-label",
      "textContent",
      "search.replaceLabel",
    ],
    ...
    [
      ".search-button.multi-btn .search-button-label",
      "textContent",
      "search.replaceAllLabel",
    ],
