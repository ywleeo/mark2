...
7. 把续写当作连载中的“下一小段情节”，只推进当前场景或下一个具体动作。
8. 不要在本次续写里完结故事、总结主题、升华感悟、给出命运定论或写出大结局。
9. 不要使用“原来/终于/从此/那一刻/老天爷/命运/一切都明白了”这类收束式表达。
10. 优先写具体细节、人物动作、对话、环境变化和新的阻碍，让故事还能继续往后写。
11. 结尾可以停在动作、发现、疑问、冲突或悬念上，但不要收束。
12. 控制长度在 ${lengthHint} 左右。`;
}
