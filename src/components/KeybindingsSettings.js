...
const CUSTOMIZABLE_COMMANDS = [
    ...
    COMMAND_IDS.FEATURE_TERMINAL_TOGGLE,
    COMMAND_IDS.FEATURE_TERMINAL_SHOW_HISTORY,
    COMMAND_IDS.FEATURE_AI_TOGGLE,
...
const COMMAND_LABELS = {
    ...
    [COMMAND_IDS.FEATURE_TERMINAL_TOGGLE]: 'settings.kb.terminal',
    [COMMAND_IDS.FEATURE_TERMINAL_SHOW_HISTORY]: 'settings.kb.terminalHistory',
    [COMMAND_IDS.FEATURE_AI_TOGGLE]: 'settings.kb.ai',
