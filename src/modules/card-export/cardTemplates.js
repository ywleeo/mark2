...
内容原则：不改写、不删减、不添加任何文字。可以将长句在自然停顿处拆分为多个 <p>，让每行短而有节奏感。原文超过 7 行时才提炼压缩，确保总行数不超过 7 行。字数不足时无需添字，排版系统会自动放大字号。
...
内容原则：不改写、不删减、不添加任何文字。可以将长句在自然停顿处拆分为多个 <p>，让每行短而有节奏感。原文超过 9 行时才提炼压缩，确保总行数不超过 9 行。字数不足时无需添字，排版系统会自动放大字号。
...
内容原则：如果原文在 9 行以内（每行 ≤ 16 字），只加排版标签，不改写任何文字。原文超过 9 行时才提炼压缩，确保总行数不超过 9 行。字数不足时无需添字，排版系统会自动放大字号。
